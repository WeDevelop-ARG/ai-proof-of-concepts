...
# This function lets the classifier directly identify the labels from the name of 
...
""" Arguments:
	...
	class_mode : Determines the type of label arrays that are returned.One of “categorical”, 
...
""" Arguments
	...
	samples_per_epoch: Total number of steps (batches of samples) to yield from generator 
											before declaring one epoch finished and starting the next epoch. 
											It should typically be equal to the number of samples of your dataset 
											divided by the batch size.
	nb_epoch: Total number of epochs. One complete cycle of predictions of a neural network is 
						called an epoch.
	validation_data: A generator sequence used to test and evaluate the predictions of the 
										neural network(Test_set).
	nb_val_samples: Total number of steps (batches of samples) to yield from validation_data 
									generator before stopping at the end of every epoch.
"""
...
"""
The above function trains the neural network using the training set and evaluates its 
performance on the test set. The functions returns two metrics for each epoch ‘acc’ and ‘val_acc’ 
which are the accuracy of predictions obtained in the training set and accuracy attained in 
