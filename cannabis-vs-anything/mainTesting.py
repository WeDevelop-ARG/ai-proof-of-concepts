...
def printLabelPredictionForImages(imagesPath: list):
    for img in images:
        ...
        if (argmax == 0):
            print(str(img) + ' - ' + 'this is not a cannabis plant - accuracy on prediction: ' + str(percentage))
        else:
            print(str(img) + ' - ' + 'this is a cannabis plant - accuracy on prediction: ' + str(percentage))
